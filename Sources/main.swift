...
let PVE_COUNT = 20
let CARDS = ["shenniu", "bingnv", "xiaohei", "xiongmao", "jiansheng", "zhousi", "xiaokulou", "fengxing"]
...
router.get("/pve/character/reload") { (request, response, next) in
    
    MMPVECharactersRepo.sharedInstance.reload()
